...
void Valar_Morghuils()
{
	
	//显示坐标
	if(pos_x>=0)
	{
		LCD_DisplayString(75,10,16," ");
		LCD_DisplayNum(80,10,pos_x,4,16,0);
	}
	else
	{
		LCD_DisplayString(75,10,16,"-");
	...
	if(pos_y>=0)
	{
		LCD_DisplayString(165,10,16," ");
		LCD_DisplayNum(170,10,pos_y,5,16,0);
	}
	else
	{
		LCD_DisplayString(165,10,16,"-");
	...
	if(zangle>=0)
	{
		LCD_DisplayString(70,35,16," ");		
		LCD_DisplayNum(80,35,zangle,5,16,0);
	}
	else
	{
		LCD_DisplayString(70,35,16,"-");		
...
//	显示速度
		if(rm3508_pid[0].target>=0)
	{
		LCD_DisplayString(70,55,16," ");		
		LCD_DisplayNum(80,55,rm3508_pid[0].target,5,16,0);
	}
	else
	{
		LCD_DisplayString(70,55,16,"-");		
	...
	if(rm3508_pid[1].target>=0)
	{
		LCD_DisplayString(70,75,16," ");		
		LCD_DisplayNum(80,75,rm3508_pid[1].target,5,16,0);
	}
	else
	{
		LCD_DisplayString(70,75,16,"-");		
	...
	if(rm3508_pid[2].target>=0)
	{
		LCD_DisplayString(70,95,16,"-");		
		LCD_DisplayNum(80,95,rm3508_pid[2].target,5,16,0);
	}
	else
	{
		LCD_DisplayString(70,95,16," ");		
...
/*
	In the name of warrior, I charge you to be brave.
	In the name of the Father,I charge you to be just.
	In the name of the Mother,T charge you defend the innocent.
	Arise ,Breni of Tasl,a knight of seven kingdom.
